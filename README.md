To get started, clone down the WebPack boilerplate and
1. change the directory name to 'ternary-traveler`
1. cd into `ternary-traveler` and run npm install
1. create a new repo in your account on github <<-- not locally. The local repo already will exist from the cloning of the WebPack boilerplate
1. change your remote origin to the new repo you just created with `git remote remove origin` then `git remote add origin foo-blah-your-github-repo-url`
1. Replace the README text with the markdown below, which contains all the requirements for building the app.
